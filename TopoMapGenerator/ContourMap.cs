...
public class ContourMap : MonoBehaviour
{
    ...
    )
    {
        ...
        Texture2D topoMap = new Texture2D(width, height, TextureFormat.RGBA32, false, false);
        topoMap.filterMode = FilterMode.Point;
        topoMap.wrapMode = TextureWrapMode.Repeat;
        topoMap.anisoLevel = 0;
    ...
    public static void SaveTextureToSceneFile(Texture2D texture)
    {
        SaveTextureToSceneFile(texture, "TopoMaps");
    }
